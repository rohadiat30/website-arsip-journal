...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <div class="container-fluid py-4">
                ...
                <div class="card my-2 ">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-warning shadow-dark border-radius-lg pt-4 pb-3">
                            <div class="row">
                                <div class="col mt-1">
                                    <h6 class="text-white text-capitalize ps-3">akutansi dan humaniora jurnal pengabdian masyarakat (AHJPM</h6>
                                </div>
                                <div class="col mx-4 mt-2">
                                    <a href="<?= base_url('/ahjpm/create') ?>" class="btn btn-info btn-sm" style="float:right;"><span class="material-icons opacity-10">add_circle</span> &nbsp;tambah</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/ahjpm/edit/ <?= $row['id'] ?>" class="btn btn-success btn-sm"><span class="material-icons opacity-10">edit</a>
                                        <form action="/ahjpm/<?= $row['id']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
        ...
        <a href="<?= base_url('/ahjpm/print') ?>" class="btn btn-info btn-md my-2"><span class=" material-icons opacity-10">local_printshop</span> &nbsp; print</a>
    </div>
</main>
<?= $this->endSection() ?>